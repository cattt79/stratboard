...
import tether_img from '/game/vfx/channeling/eff/chn_m0146_win01h@3x.png?url'

// 实现类似 vfx/channeling/eff/chn_m0146_win01h.avfx 的效果
export async function create_chn_m0146_win01h(length: number) {
